...
genet can be memory intensive; we like to ensure that any development to the core code does not exacerbate this.
...
1. Install [memray](https://bloomberg.github.io/memray/index.html) in your `genet` mamba environment: `mamba install memray pytest-memray`.
