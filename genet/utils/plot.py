...
LAYERS = {
    'network_links': {
        'fieldsToShow': {
            'network_links': [{'name': 'id', 'format': None}, {'name': 'from', 'format': None},
                              {'name': 'to', 'format': None}, {'name': 'freespeed', 'format': None},
    ...
    'schedule_routes': {
        'fieldsToShow': {
            'schedule_routes': [{'name': 'route_id', 'format': None}, {'name': 'mode', 'format': None},
                                {'name': 'route_short_name', 'format': None}, {'name': 'service_id', 'format': None}]},
        'layer': {
            'id': 'schedule_routes',
            'type': 'geojson',
    ...
    'schedule_stops': {
        'fieldsToShow': {
            'schedule_stops': [{'name': 'id', 'format': None}, {'name': 'x', 'format': None},
                               {'name': 'y', 'format': None}, {'name': 'name', 'format': None},
                               {'name': 'linkRefId', 'format': None}]},
        'layer': {'id': 'schedule_stops',
                  'type': 'point',
