...
* Look at open issues tagged with ["help wanted"](https://github.com/arup-group/genet/issues?q=is%3Aissue+is%3Aopen+label%3A%22help+wanted%22) and ["good first issue"](https://github.com/arup-group/genet/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22)
* Look at the [contributing guide in our documentation](https://arup-group.github.io/genet/contributing)

## Licensing

By contributing to genet, i.e. through opening a pull request, you represent that your contributions are your own original work and that you have the right to license them, and you agree that your contributions are licensed under the genet.

## Reporting bugs and requesting features

You can open an issue on GitHub to report bugs or request new genet features.
Follow these links to submit your issue:

- [Report bugs or other problems while running genet](https://github.com/arup-group/genet/issues/new?template=BUG-REPORT.yml).
If reporting an error, please include a full traceback in your issue.

- [Request features that genet does not already include](https://github.com/arup-group/genet/issues/new?template=FEATURE-REQUEST.yml).

- [Report missing or inconsistent information in our documentation](https://github.com/arup-group/genet/issues/new?template=DOCS.yml).

- [Any other issue](https://github.com/arup-group/genet/issues/new).
