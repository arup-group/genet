...
def test_initiating_service(service):
    ...
    assert_semantically_equal(
        service._graph.edges(data=True)._adjdict,
        {
...
def test_route_is_not_in_exact_list(similar_non_exact_test_route, test_service):
    a = Service(id="service", routes=[similar_non_exact_test_route])
...
def test_build_graph_builds_correct_graph_when_some_stops_overlap():
    ...
    assert_semantically_equal(
        list(g.edges), [("1", "6"), ("6", "7"), ("7", "4"), ("1", "2"), ("2", "3"), ("3", "4")]
    )
        ...
        DataFrame(
            {
                ...
                "trip_departure_time": {
                    0: Timestamp("1970-01-01 13:00:00"),
                    1: Timestamp("1970-01-01 13:30:00"),
                    2: Timestamp("1970-01-01 11:00:00"),
                    3: Timestamp("1970-01-01 13:00:00"),
                },
