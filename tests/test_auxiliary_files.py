        ...
        Service(
            ...
            routes=[
                Route(
                    ...
                    trips={
                        "trip_id": ["1"],
                        "trip_departure_time": ["02:20:20"],
                        "vehicle_id": ["1"],
                    },
                    stops=[
                        Stop("stop_1", epsg="epsg:27700", x=1, y=2),
...
def test_attaching_links_benchmark_to_network(links_benchmark, network):
    ...
    assert links_benchmark.attachments == [
        {"car": {"1": {"in": "links"}}},
        {"car": {"1": {"out": "links"}}},
        {"car": {"2": {"in": "links"}}},
        {"car": {"2": {"out": "links"}}},
...
def test_building_identity_map_for_links_benchmark_csv(links_benchmark_csv):
    ...
    assert links_benchmark_csv.map == {
        "8": "8",
        "3": "3",
        "4": "4",
        "1": "1",
...
def test_updating_links_benchmark_csv(links_benchmark_csv):
    ...
    correct_data = DataFrame(
        {
            "id": {0: "L001", 1: "L001", 2: "L002", 3: "L002"},
