...
def test_network():
    return read.read_matsim(
        path_to_network=network_test_file, epsg="epsg:27700", path_to_schedule=schedule_test_file
    )
    ...
    return Service(
        ...
        routes=[
            Route(
                ...
                stops=[
                    Stop(
                        epsg="epsg:27700", id="490004695A", x=529871.7641447927, y=181148.2259665833
                    ),
                    Stop(
                        epsg="epsg:27700", id="490000235C", x=529741.7652299237, y=181516.3450505745
                    ),
                    Stop(
                        epsg="epsg:27700",
                        id="490000089A",
            ...
            Route(
                ...
                stops=[
                    ...
                    Stop(
                        epsg="epsg:27700", id="490000252X", x=529299.7788544403, y=182221.2500579671
                    ),
                    Stop(
                        epsg="epsg:27700",
                        id="490000078Q",
                        x=529350.7866918372,
                        y=182388.01590025262,
                    ),
                ],
                trips={
                    "trip_id": ["trip_2"],
    ...
    df = DataFrame(
        {
            ...
            "link_id": {
                4: "5221390698590575489_5221390721979501095",
                5: "52213908340665748775221390828301496736",
                ...
                10: "5221390698557344687_5221390698590575489",
                11: "5221390688502743083_5221390698590575489",
                12: "5221390688502743083_5221390688502743083",
                13: "5221390319100521975_5221390688502743083",
                14: "5221390688502743083_5221390698590575489",
                15: "5221390319261602009_5221390688502743083",
                16: "5221390688613602227_5221390688502743083",
            },
            "id": {
                4: "5221390721979501095",
                5: "5221390721979501095",
                6: "5221390721979501095",
                7: "5221390721979501095",
                8: "5221390698590575489",
                9: "5221390698590575489",
                10: "5221390698590575489",
                11: "5221390698590575489",
                12: "5221390688502743083",
                13: "5221390688502743083",
                14: "5221390688502743083",
                15: "5221390688502743083",
                16: "5221390688502743083",
            },
            "catchment": {
                4: 5,
                5: 5,
            ...
            "problem_nodes": {
                ...
                16: "5221390688502743083.link:5221390688613602227_5221390688502743083",
            },
        }
    ).set_index("id", drop=False)
    df.index.rename(name="index", inplace=True)
    mocker.patch.object(spatial.SpatialTree, "closest_links", return_value=df)
...
def test_snapping_disconnected_partial_pt_route_results_in_all_stops_with_link_references_and_routes_between_viable_catchments(
    ...
    df = DataFrame(
        {
            ...
            "link_id": {
                0: "5221390319100521975_5221390688502743083",
                1: "5221390319100521975_5221390319062365867",
                2: "5221390319100521975_5221390319100521975",
                3: "5221390319091334983_5221390319100521975",
                4: "5221390698590575489_5221390721979501095",
                5: "52213908340665748775221390828301496736",
                6: "5221390721979501095_5221390721979501095",
                7: "5221390721979501095_5221390721985855617",
            ...
            "id": {
                0: "5221390319100521975",
                1: "5221390319100521975",
                2: "5221390319100521975",
                3: "5221390319100521975",
                4: "5221390721979501095",
                5: "5221390721979501095",
                6: "5221390721979501095",
                7: "5221390721979501095",
    ...
    mss.route_edges()
    assert set(mss.pt_edges[mss.pt_edges["shortest_path"].isna()]["u"]) == {
        "5221390698590575489",
        "5221390688502743083",
    }
    assert set(mss.pt_edges[mss.pt_edges["shortest_path"].isna()]["v"]) == {
        "5221390698590575489",
        "5221390721979501095",
    }
...
def test_artificially_filling_in_solution_for_partial_pt_routing_problem_results_in_correct_solution_and_routed_path(
    ...
    assert mss.routed_path(
        ...
        "5221390688502743083_5221390698590575489",
        "5221390698590575489_5221390721979501095",
    ]
...
def test_routing_services_with_shared_stops(test_network, test_service):
            ...
            Service(
                ...
                routes=[
                    Route(
                        ...
                        stops=[
                            Stop(
                                epsg="epsg:27700", id="A", x=529871.7641447927, y=181148.2259665833
                            ),
                            Stop(
                                epsg="epsg:27700",
                                id="490000235C",
    ...
    test_network.route_service("service_bus", additional_modes="car")
    assert test_network.schedule["other_service_bus"].reference_edges() == {
        ("A", "490000235C"),
...
def test_teleporting_more_than_one_service(test_network, test_service):
    ...
    for link in {
        ...
        assert test_network.has_link(link)
    assert test_network.link("artificial_link===from:490004695A===to:490000235C")["modes"] == {
        "rail",
        "bus",
    }
    assert test_network.link("artificial_link===from:490000235C===to:490000235C")["modes"] == {
        "rail",
        "bus",
    }
    assert test_network.link("artificial_link===from:49000008900000===to:49000008900000")[
        "modes"
    ] == {"rail"}
...
def test_teleporting_service_with_some_snapped_stops(test_network, test_service):
    test_network.schedule = Schedule(epsg="epsg:27700", services=[test_service])
    test_network.schedule._graph.nodes["490000252X"][
        "linkRefId"
    ] = "5221366094904818311_5221366094903752729"
    test_network.apply_attributes_to_links(
        {
            "5221366094904818311_5221366094903752729": {
                "modes": test_network.link("5221366094904818311_5221366094903752729")["modes"]
                | {"bus"}
            }
        }
    )
...
def test_rerouting_with_stops_that_have_repeated_linkrefids_does_not_route_between_shared_linkrefid(
    test_network,
):
    old_route = test_network.schedule.route("7797_1").route
    test_network.schedule._graph.nodes["5221390696959560817"][
        "linkRefId"
    ] = "5221390688151572741_5221390688151572741"
    stops_linkrefids = [
        test_network.schedule._graph.nodes[stop]["linkRefId"]
        for stop in test_network.schedule._graph.graph["routes"]["7797_1"]["ordered_stops"]
    ]
    assert stops_linkrefids == [
        "5221390668024400277_5221390668024400277",
        "5221390679263486719_5221390679263486719",
        "5221390681543854913_5221390681543854913",
        "5221390705165650355_5221390705165650355",
