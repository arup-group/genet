...
def test_generate_validation_report_with_correct_schedule(correct_schedule):
    correct_report = {
        'schedule_level': {'is_valid': False, 'has_valid_services': False, 'invalid_services': ['service']},
        'service_level': {'service': {'is_valid': False, 'has_valid_routes': True, 'invalid_routes': []}},
        'route_level': {'service': [{'is_valid_route': True}, {'is_valid_route': True}]}}
...
def test_generate_validation_report_with_incorrect_schedule(test_schedule):
    correct_report = {
        'schedule_level': {'is_valid': False, 'has_valid_services': False, 'invalid_services': ['service']},
        'service_level': {'service': {'is_valid': False, 'has_valid_routes': False, 'invalid_routes': [0, 1]}},
