    ...
    correct_report = {
        'schedule_level': {'is_valid_schedule': False, 'invalid_stages': ['not_has_valid_services'],
            ...
            'service': {'is_valid_service': False,
                        'invalid_stages': ['not_has_valid_routes', 'not_has_uniquely_indexed_routes'],
                        'has_valid_routes': False, 'invalid_routes': [0, 1]}}, 'route_level': {'service': {
            0: {'is_valid_route': False, 'invalid_stages': ['not_has_correctly_ordered_route', 'has_self_loops']},
            1: {'is_valid_route': False, 'invalid_stages': ['not_has_correctly_ordered_route', 'has_self_loops']}}}}
